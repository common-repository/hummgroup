...
(function ($) {
	...
	$(
		function () {
			var regionSelect = $( "select#woocommerce_humm_country" );
			var au_settings  = $( "#woocommerce_humm_au_settings" ).next();
			var nz_settings  = $( "#woocommerce_humm_nz_settings" ).next();
	...
	$(
		function () {
			var priceWidgetSetting        = $( "input#woocommerce_humm_price_widget" );
			var priceWidgetAdvanced       = $( "input#woocommerce_humm_price_widget_advanced" );
			var dynamicPriceWidgetSetting = $( "input#woocommerce_humm_price_widget_dynamic_enabled" );

			var priceWidgetAdvancedBlock        = priceWidgetAdvanced.parent().parent().parent().parent();
			var priceWidgetElementSelectorBlock = $( "input#woocommerce_humm_price_widget_element_selector" ).parent().parent().parent();
			var dynamicPriceWidgetSettingBlock  = dynamicPriceWidgetSetting.parent().parent().parent().parent();
			var priceWidgetCssSelectorBlock     = $( "input#woocommerce_humm_price_widget_price_selector" ).parent().parent().parent();
	...
	$(
		function () {
			var topBannerWidgetSetting                         = $( "input#woocommerce_humm_top_banner_widget" );
			var topBannerWidgetSettingShowOnFrontpageOnlyBlock = $( "input#woocommerce_humm_top_banner_widget_homepage_only" ).parent().parent().parent();
